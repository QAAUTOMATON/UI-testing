...
error001 = "try_except loop error"
# ===================================================
current_row = 6
current_column = 18
# -------------------------Logging in-------------------------------
...
try:
    ...
    if ele.is_displayed():
        ele.click()
        wait(1)
        if input_box(ele, "invalidcode") == 1:
            writeData(inputFileName, inputSheetName, r + current_row, c + current_column, 'pass')
    else:
        writeData(inputFileName, inputSheetName, r + current_row, c + current_column, 'fail')
except:
...
# ------------------------------------------click on buy yearly subscription--------------------------------------
current_row = 14
try:
...
#         ele.click()
#         wait(10)
#         ele2 = driver.find_element(By.ID, "submit-button")
#         wait(1)
#         if ele2.is_displayed():
#             ele2.click()
#             wait(10)
...
# updateStatus(inputFileName, inputSheetName, current_row, current_column, day)
#
# # -------------------------------fill contact info pay now yearly subscription----------------------------
# current_row = 29
# try:
...
# updateStatus(inputFileName, inputSheetName, current_row, current_column, day)
#
# # --------------------------------fill mail pay now yearly subscription----------------------------------
# current_row = 30
# try:
...
try:
    ...
    if ele.is_displayed():
        ele.click()
        wait(5)
        if driver.current_url == "https://mynextfilm.com/pay/verifygift":
            writeData(inputFileName, inputSheetName, r + current_row, c + current_column, 'pass')
    else:
        writeData(inputFileName, inputSheetName, r + current_row, c + current_column, 'fail')
except:
...
# --------------------------------claim gift subscription without promo----------------------------------
current_row = 33
try:
    ele = driver.find_element(By.ID, 'refer')
    if ele.is_displayed():
        ele.click()
        wait(5)
        if driver.current_url == "https://mynextfilm.com/pay/verifygift":
...
# --------------------------------claim gift subscription fill invalid promo----------------------------
current_row = 34
try:
    ele = driver.find_element(By.NAME, 'token')
    if ele.is_displayed():
        ele.click()
        wait(5)
        if input_box(ele, "invalidpromo") == 1:
            writeData(inputFileName, inputSheetName, r + current_row, c + current_column, 'pass')
    else:
        writeData(inputFileName, inputSheetName, r + current_row, c + current_column, 'fail')
except:
...
# --------------------------------claim gift subscription fill valid promo----------------------------------
current_row = 36
try:
    ele = driver.find_element(By.NAME, 'token')
    if ele.is_displayed():
